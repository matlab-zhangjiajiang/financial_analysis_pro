...
# news_crawler.save_news(sina_news_df, os.path.join(news_path, 'sina_latest_news.excel'))
# news_crawler.save_news(sohu_news_df, os.path.join(news_path, 'sohu_latest_news.excel'))
# news_crawler.save_news(xinhuanet_news_df, os.path.join(news_path, 'xinhuanet_latest_news.excel'))
...
#news_crawler.save_news(news_df, os.path.join(news_path, 'latest_news.excel'))
