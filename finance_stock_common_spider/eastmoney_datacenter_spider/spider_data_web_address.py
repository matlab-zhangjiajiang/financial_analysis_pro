...
class spider_web_address(object):
      ...
      DATA_URL = {'INCREASE_USERS':'http://data.eastmoney.com/DataCenter_V3/Chart/cjsj/weeklystockaccountsnew.ashx?isxml=true',
                  ...
                  'TOP_TEN_HOLDER_NEW_ADDER':'http://data.eastmoney.com/gdfx/holdingDetail.aspx?cgbd=1',
                  'TOP_TEN_HOLDER_CURRENT_ADDER':'http://data.eastmoney.com/gdfx/holdingDetail.aspx?cgbd=2'}