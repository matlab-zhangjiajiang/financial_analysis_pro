...
class spider_web_address(object):
      ...
      DATA_URL = {'INCREASE_USERS':'http://data.eastmoney.com/DataCenter_V3/Chart/cjsj/weeklystockaccountsnew.ashx?isxml=true',
                  ...
                  'TOP_TEN_HOLDER_ADDER':'http://data.eastmoney.com/DataCenter_V3/gdfx/data.ashx?SortType=NDATE&SortRule=1&PageIndex=1&PageSize=10&jsObj=DlswLagO&type=NSHDDETAIL&date=&gdlx=0&cgbd=1&rt=52888792'}